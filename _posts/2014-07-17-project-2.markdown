...
description: As a coursework for Games Architecture i had to make a 3D version of pacman, using component based architecture. a Video of This game in action can be seen Here 
